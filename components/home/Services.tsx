      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div style={{ borderTop: "1px solid var(--bdr)" }}>
          {services.map((service) => (
            ...
            >
              <span className="text-xs font-mono pt-1" style={{ color: "var(--acc)" }}>{service.number}</span>
              <div>
              ...
              <div className="hidden md:flex items-center pt-1">
                <span className="text-lg transition-all duration-200 opacity-0 group-hover:opacity-100 group-hover:translate-x-1" style={{ color: "var(--acc)" }}>→</span>
              </div>
            </div>
          ))}
        </div>
