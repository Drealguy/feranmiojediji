  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 40%, color-mix(in srgb, var(--txt) 6%, transparent) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative mb-8 select-none" aria-hidden="true">
        ...
        >
          ...
          <polygon points="30,60 70,40 110,60 70,80" fill="var(--txt)" />
          ...
          <polygon points="30,115 110,75 150,95 70,135" fill="var(--txt)" />
          ...
          <polygon points="110,40 150,20 190,40 150,60" fill="var(--txt)" />
          ...
          {/* ── RIGHT "4" ── */}
          {/* Vertical left bar, top face */}
          <polygon points="330,60 370,40 410,60 370,80" fill="var(--txt)" />
          {/* Vertical left bar, right face */}
          ...
          {/* Horizontal crossbar, top face */}
          <polygon points="330,115 410,75 450,95 370,135" fill="var(--txt)" />
          {/* Horizontal crossbar, right face */}
          ...
          {/* Vertical right bar, top face */}
          <polygon points="410,40 450,20 490,40 450,60" fill="var(--txt)" />
          {/* Vertical right bar, right face */}
          ...
          {/* Outer top ellipse */}
          <ellipse cx="260" cy="72" rx="48" ry="24" fill="#1e1e1e" stroke="var(--txt)" strokeWidth="2" />
          {/* Outer right face */}
          ...
          {/* Outer bottom rim */}
          <ellipse cx="260" cy="158" rx="48" ry="24" fill="none" stroke="var(--txt)" strokeWidth="2" />

          {/* ── Ladder inside the "0" ── */}
          {/* Left rail */}
          <line x1="245" y1="80" x2="245" y2="150" stroke="var(--txt)" strokeWidth="3" strokeLinecap="round" />
          {/* Right rail */}
          <line x1="275" y1="80" x2="275" y2="150" stroke="var(--txt)" strokeWidth="3" strokeLinecap="round" />
          {/* Rungs */}
          <line x1="245" y1="95" x2="275" y2="95" stroke="var(--txt)" strokeWidth="2.5" strokeLinecap="round" />
          <line x1="245" y1="110" x2="275" y2="110" stroke="var(--txt)" strokeWidth="2.5" strokeLinecap="round" />
          <line x1="245" y1="125" x2="275" y2="125" stroke="var(--txt)" strokeWidth="2.5" strokeLinecap="round" />
          <line x1="245" y1="140" x2="275" y2="140" stroke="var(--txt)" strokeWidth="2.5" strokeLinecap="round" />

          {/* Tiny figure climbing */}
          {/* Body */}
          <circle cx="260" cy="85" r="5" fill="var(--txt)" />
          <line x1="260" y1="90" x2="260" y2="102" stroke="var(--txt)" strokeWidth="2.5" strokeLinecap="round" />
          {/* Arms */}
          <line x1="260" y1="93" x2="253" y2="98" stroke="var(--txt)" strokeWidth="2" strokeLinecap="round" />
          <line x1="260" y1="93" x2="267" y2="88" stroke="var(--txt)" strokeWidth="2" strokeLinecap="round" />
          {/* Legs */}
          <line x1="260" y1="102" x2="255" y2="109" stroke="var(--txt)" strokeWidth="2" strokeLinecap="round" />
          <line x1="260" y1="102" x2="265" y2="107" stroke="var(--txt)" strokeWidth="2" strokeLinecap="round" />
        </svg>
      </div>
