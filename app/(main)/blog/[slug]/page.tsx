...
const DEMO_BODY: Record<string, object[]> = {
  "why-your-website-is-losing-clients": [
    ...
    b("Visitors shouldn't have to guess what to do next. If your homepage doesn't have a single, obvious CTA above the fold, such as 'Book a call', 'Get a quote', or 'Start your project', you're leaking money every single day."),
    ...
    b("People buy from people they trust. If your website has no testimonials, case studies, or client logos, you're asking strangers to take a leap of faith. Most won't."),
  ...
  "brand-identity-checklist-nigerian-business": [
    ...
    b("A logo is one tiny piece of a brand. Here's the full checklist I walk every client through before we design a single thing."),
    ...
    b("Brand identity is the complete visual and verbal system that communicates who you are, what you stand for, and why clients should choose you. It includes your logo, colours, typography, tone of voice, photography style, and how every touchpoint feels."),
  ...
  "ai-tools-for-better-design": [
    ...
    b("These are the exact tools and workflows I use. This isn't a generic list; these are the ones I actually open every day and the specific ways I use them."),
    ...
    b("I use Claude for strategy and long-form thinking, including drafting proposals, structuring content strategy, and writing website copy briefs. The key insight: I never use AI to write final copy. I use it to think faster and structure better, then I write the final version myself."),
    ...
    b("The time I save on research and exploration gets reinvested into the craft: better typography choices, more refined layouts, and stronger copy. The output is genuinely better."),
  ...
  block: {
    ...
    blockquote: ({ children }) => (
      <blockquote
        ...
        style={{ borderLeft: "3px solid var(--acc)", color: "var(--mut)", background: "color-mix(in srgb, var(--txt) 4%, transparent)" }}
      >
        {children}
      </blockquote>
    ),
