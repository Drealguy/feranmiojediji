...
const services = [
  ...
  { _id: "service-4", number: "04", title: "Social Media Design", description: "Automate your workflows with AI. Content pipelines, lead generation, and client onboarding — on autopilot.", tags: ["Make.com", "AI", "Workflows"], order: 4 },
...
const projects = [
  ...
  { _id: "project-5", title: "AutoFlow — AI Workflow", slug: { current: "autoflow-ai" }, category: "Social Media Design", year: "2025", description: "AI-powered content and lead generation system.", accentColor: "#34d399", tags: ["Make.com", "AI", "Automation"], featured: false, order: 5 },
